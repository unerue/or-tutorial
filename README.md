...
2. **민감도 분석 (Sensitivity Analysis)** - [sensitivity-analysis.ipynb](hhttps://nbviewer.jupyter.org/github/unerue/or-tutorial/blob/master/or-tutorial/linear-programming/sensitivity-analysis.ipynb)
